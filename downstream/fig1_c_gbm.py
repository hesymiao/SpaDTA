...
OUTPUT_DIR = RUN_ROOT / "fig1_c_248_T"

METABOLITE_FEATURE = "238.7857738747654"
SOURCE_RECONSTRUCTION_LAYER = "reconstruction_decalign_linear"
SELECTED_GENE_FEATURE = "COL4A1"
...
def plot_hex_spatial_pair(adata: sc.AnnData, layer: str, output_path: Path) -> None:
    ...
    gene_pcc = get_selected_feature_pcc(
        adata,
        feature_type="ST",
        selected_feature=SELECTED_GENE_FEATURE,
    ...
    fig.suptitle(
        f"248_T | {SELECTED_GENE_FEATURE} (PCC={gene_pcc:.4f}) | {METABOLITE_FEATURE} (PCC={metabolite_pcc:.4f})",
        fontsize=14,
        y=0.98,
    )
