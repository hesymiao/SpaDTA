...
sample = 'R114_T'
input_h5ad = Path(f"/data/user/hesy/projects/SpatialMETA/spaDTA/runs/first/{sample}/{sample}_targetcount.h5ad")
output_path = Path(f"/data/user/hesy/projects/SpatialMETA/spaDTA/runs/first/{sample}/{sample}_cluster.svg")
