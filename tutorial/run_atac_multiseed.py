...
processed_root = Path(
    "/bigdat2/user/hesy/spatialmeta/SpatialMETA/SpaDTA_718_model_input_seed42_20260719/ATAC"
)
...
if __name__ == "__main__":
    ...
    run_train_eval_cli(
        ...
        default_output_root=package_root / "runs" / "atac_multiseed" / selected_sample,
